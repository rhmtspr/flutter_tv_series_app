...
void main() {
  ...
  group('now playing movies', () {
    test('initialState should be Empty', () {
      expect(provider.nowPlayingState, equals(RequestState.emptyState));
    });
    ...
    test('should change state to Loading when usecase is called', () {
      ...
      provider.fetchNowPlayingMovies();
      // assert
      expect(provider.nowPlayingState, RequestState.loadingState);
    });
    ...
    test('should change movies when data is gotten successfully', () async {
      ...
      // assert
      expect(provider.nowPlayingState, RequestState.loadedState);
    ...
    test('should return error when data is unsuccessful', () async {
      ...
      await provider.fetchNowPlayingMovies();
      // assert
      expect(provider.nowPlayingState, RequestState.errorState);
  ...
  group('popular movies', () {
    test('should change state to loading when usecase is called', () async {
      ...
      // assert
      expect(provider.popularMoviesState, RequestState.loadingState);
    });
    ...
    test(
      ...
      () async {
        ...
        // assert
        expect(provider.popularMoviesState, RequestState.loadedState);
    ...
    test('should return error when data is unsuccessful', () async {
      ...
      await provider.fetchPopularMovies();
      // assert
      expect(provider.popularMoviesState, RequestState.errorState);
      expect(provider.message, 'Server Failure');
      expect(listenerCallCount, 2);
    });
  });
  ...
  group('top rated movies', () {
    test('should change state to loading when usecase is called', () async {
      ...
      // assert
      expect(provider.topRatedMoviesState, RequestState.loadingState);
    });
    ...
    test(
      ...
      () async {
        ...
        // assert
        expect(provider.topRatedMoviesState, RequestState.loadedState);
    ...
    test('should return error when data is unsuccessful', () async {
      ...
      await provider.fetchTopRatedMovies();
      // assert
      expect(provider.topRatedMoviesState, RequestState.errorState);
      expect(provider.message, 'Server Failure');
      expect(listenerCallCount, 2);
    });
  });
