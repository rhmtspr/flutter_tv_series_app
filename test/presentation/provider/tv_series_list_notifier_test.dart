...
void main() {
  ...
  group('now playing tv series', () {
    test('initialState should be Empty', () {
      expect(provider.nowPlayingStateTvSeries, equals(RequestState.emptyState));
    });
    ...
    test('should change state to Loading when usecase is called', () {
      ...
      provider.fetchNowPlayingTvSeries();
      // assert
      expect(provider.nowPlayingStateTvSeries, RequestState.loadingState);
    });
    ...
    test('should change tv series when data is gotten successfully', () async {
      ...
      // assert
      expect(provider.nowPlayingStateTvSeries, RequestState.loadedState);
    ...
    test('should return error when data is unsuccessful', () async {
      ...
      await provider.fetchNowPlayingTvSeries();
      // assert
      expect(provider.nowPlayingStateTvSeries, RequestState.errorState);
  ...
  group('popular tv series', () {
    test('should change state to loading when usecase is called', () async {
      ...
      // assert
      expect(provider.popularTvSeriesState, RequestState.loadingState);
    });
    ...
    test(
      ...
      () async {
        ...
        // assert
        expect(provider.popularTvSeriesState, RequestState.loadedState);
    ...
    test('should return error when data is unsuccessful', () async {
      ...
      await provider.fetchPopularTvSeries();
      // assert
      expect(provider.popularTvSeriesState, RequestState.errorState);
      expect(provider.message, 'Server Failure');
      expect(listenerCallCount, 2);
    });
  });
  ...
  group('top rated tv series', () {
    test('should change state to loading when usecase is called', () async {
      ...
      // assert
      expect(provider.topRatedTvSeriesState, RequestState.loadingState);
    });
    ...
    test(
      ...
      () async {
        ...
        // assert
        expect(provider.topRatedTvSeriesState, RequestState.loadedState);
    ...
    test('should return error when data is unsuccessful', () async {
      ...
      await provider.fetchTopRatedTvSeries();
      // assert
      expect(provider.topRatedTvSeriesState, RequestState.errorState);
      expect(provider.message, 'Server Failure');
      expect(listenerCallCount, 2);
    });
  });
